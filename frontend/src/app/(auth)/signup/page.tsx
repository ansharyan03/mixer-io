    ...
    <div className="flex flex-col h-screen">
      ...
      <header className="flex items-center justify-between px-4 py-3">
        ...
        <img
          ...
          alt="1989 Album Cover"
          className="absolute top-30 sm:hidden left-10 w-50 h-50 opacity-20 pointer-events-none -z-10"
        />
        <img
          src="/1989.png"
          alt="abbey-road"
          className="absolute sm:hidden bottom-20 right-10 w-50 h-50 opacity-20 pointer-events-none -z-10"
        />
